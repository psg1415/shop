...
public class Member extends Dto<Member> {
	...
	public Member(int memNo, String memId, String memPw, String memPwHint, String memNm, String cellPhone, String address, String socialType, String socialId, String regDt) {
		this.memNo = memNo;
		this.memId = memId;
		this.memPw = memPw;
